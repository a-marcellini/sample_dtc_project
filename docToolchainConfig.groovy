...
inputFiles = [
	...
	[file: 'helloworld.adoc', formats: ['html','pdf']],
	/** inputFiles **/
]
...
confluence.with {
    ...
    api = 'https://iungoitalia.atlassian.net/wiki/rest/api/'

    useV1Api = false

    // extraPageContent = 'Generated page'
    ...
    // spaceKey = 'IA'
    // spaceKey = '~61f127f4aeaacb007203eee7'
...
structurizr.with {
    ...
    export = {
        ...
        // outputPath = 'src/docs/gendiagrams'
